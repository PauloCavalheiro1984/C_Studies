...
void tabulate(void)
{
    ...
    {
        int v = 0;
        while (candidates[preferences[t][v]].eliminated == true)
        {
            v++;
        }
        candidates[preferences[t][v]].votes++;
    }
    return;
}
...
int find_min(void)
{
    ...
    {
        if (candidates[m].eliminated == false && lowest > candidates[m].votes)
        {
...
bool is_tie(int min)
{
    ...
    {
        if (candidates[y].eliminated == false && candidates[y].votes != min)
        {
            return false;
        }
    }
